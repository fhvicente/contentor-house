...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-gray-900 text-white pt-16 pb-8 mt-auto flex-shrink-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <address className="not-italic text-gray-400">
                            ...
                            <p className="mb-2">
                                <a href="mailto:info@contentorhouse.com" className="hover:text-white transition-colors">info@contentorhouse.com</a>
                            </p>
                        </address>
                    </div>
                </div>
